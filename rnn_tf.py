...
"""
# code based on https://github.com/spiglerg/RNN_Text_Generation_Tensorflow
...
def main():
    ...
    parser.add_argument(
        "--input_file",
        type=str,
     	# changed to run Trump speeches
	default="data/shakespeare.txt",
#	default="/media/nvidia/JetsonSSD-250/sandbox/dev/trump_speeches/data/full_speech.txt",
